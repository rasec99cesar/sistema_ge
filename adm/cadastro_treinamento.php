...
if (isset($_POST['cadastrar'])) { 	/* Se o Botão Entrar for Pressionado */
	...
	$sql =mysqli_query($mysqli,"INSERT INTO treinamento(nm_nome, ds_curta, ds_longa, bl_ativo) VALUES ('".$nome."','".$ds_curta."','".$ds_longa."','1')"); 														 /* Insere os dados do prestador */

	 if($sql==TRUE){ /* Se Obtiver Sucesso */
	 	echo'
	 	<script>
	 		alert("Cadastro Realizado Com Sucesso!");
	    	document.location = "treinamento.php";
	    ...
	    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8"> <!-- Faz os campos de texto ocuparem 8 -->
	      <div class="card">
	        <div class="card-header" style="background-color: #1D1D1B; padding-top: 8px; padding-bottom: 2px; ">
	          <h5 class="card-title" style="color:white;" > <center> Novo Treinamento </center></h5>

	        </div>
	        <div class="card-body">
	          <div class="row">
	            <form name="Usuario" id="Usuario" action="cadastro_treinamento.php" method="post" enctype="multipart/form-data"> <!-- Formulário -->
